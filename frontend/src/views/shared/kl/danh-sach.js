...
export function render() {
  ...
  const dangMo = [...document.querySelectorAll('#klBody .dong-chi-tiet:not(.hidden)')].map((tr) => ({ id: tr.id.replace('klChiTiet-', ''), moBang: Boolean(tr.querySelector('.chi-tiet-them')?.open) }));
