...
const SECTIONS = ['viewDieuHanh', 'viewChiDaoDaGui', 'viewKl', 'viewTheoVanBan', 'viewChiDaoTTThuKy', 'viewGiaoViec', 'viewCanBo', 'viewBaoCao', 'viewNhanTin', 'viewQuanTri', 'viewCaNhan', 'viewTroGiup'];
