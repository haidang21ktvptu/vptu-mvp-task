...
export const USERS = {
  A1: { username: 'demo_cvp', fullName: 'Demo Chánh Văn phòng', section: '#viewKlDashboard', roleLabel: 'Lãnh đạo Văn phòng (A1)' },
  A2: { username: 'demo_truongphong', fullName: 'Demo Trưởng phòng', section: '#viewKl', roleLabel: 'Trưởng phòng chuyên môn (A2)' },
  A3: { username: 'demo_cv1', fullName: 'Demo Chuyên viên Một', section: '#viewKl', roleLabel: 'Cán bộ thực hiện (A3)' },
};
