// Kịch bản 11 (GĐ10 PR 10D; giao diện v7): thời gian thực module KL — A1 mở Nhiệm vụ, dữ liệu đổi ở DB (service_role, như chuyên viên cập
// nhật ở máy khác) → ô số và dòng tự đổi, không bấm gì; mất mạng → chỉ báo chuyển sang "làm mới mỗi 60 giây", có mạng lại → "Cập nhật trực
