...
- Sửa `tests/e2e/nhiem-vu.spec.js`: `beforeAll(({}, testInfo))` (PR #16 đổi thành `_fixtures` cho ESLint làm Playwright từ chối tải file) — e2e 16/16 pass lại. Lighthouse Accessibility: đăng nhập 100/100, dashboard A1 90/90 (lỗi còn lại nằm ở nội dung cũ, sửa ở PR b). Ảnh 1280/360px tại `docs/anh-man-hinh/gd5/`.
