...
- **Phát hành `v3.1.1`** theo quy trình rút gọn (PR chỉ frontend, không migration, không backup tay — deploy-prod tự backup; tag trước merge). Production vẫn ở migration 0026.
