...
- Test: `kl-trang-thai` (8 case biên với ngày cố định + 4 case ràng buộc/trigger), `rls-10-kl` (12 case, gồm PCVP đổi phòng giữa chừng và vòng đính chính), `kl-moc-2026-09-14` (mốc HT 146 · TX 16 · QH 8 · ĐTH 6 · CĐK 6 · CĐH 3 = 185, tự bỏ qua tới khi PR 8B nhập đủ 185 dòng Excel) — 84 test RLS, 83 pass + 1 skip trên local. Staging: đã nạp seed `demo_qtht` + 2 dòng phụ trách sau khi merge #33, `rls-9` chạy thật 59/59.
