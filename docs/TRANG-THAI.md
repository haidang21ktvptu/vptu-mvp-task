# TRẠNG THÁI DỰ ÁN — bản bàn giao (cập nhật: 2026-09-15, GĐ9 xong — v2.2.0 trên production, ánh xạ lĩnh vực đợt 1; kế tiếp GĐ10)
...
```
Phiên kế tiếp: **GĐ10 PR 10A** — màn hình A3/A2 module KL (đọc CLAUDE.md, TRANG-THAI, `docs/thiet-ke-theo-doi-kl-btvtu.md` Phần 3.4, 4 GĐ10, 5.4 (form nhập: chọn ngành → lĩnh vực bắt buộc), 6.3, 6.8 và DESIGN.md; dữ liệu local: `supabase db reset` rồi `node scripts/nhap-kl-btvtu.mjs --file tests/rls/du-lieu-vang/kl-btvtu.json --local --ghi`). Plan mode, chờ duyệt. Song song: mục 6.2 khi có file duyệt lĩnh vực mới.
