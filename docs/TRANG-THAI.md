# TRẠNG THÁI DỰ ÁN — bản bàn giao (cập nhật: 2026-09-15, phát hành v2.1.0)
...
| 8 | Theo dõi KL BTVTU — mô hình dữ liệu và nhập liệu (`docs/thiet-ke-theo-doi-kl-btvtu.md` Phần 4) | **Đang làm**: PR 8A-1 merged #33, PR 8A-2 merged #34; **PR 8B** (0017 + `scripts/nhap-kl-btvtu.mjs` + bộ vàng ẩn danh, `kl-moc` chạy thật trên local/CI) mở 2026-09-15. Staging đã nạp bộ vàng, 85/85. Còn: phát hành `v2.1.0` (schema) rồi nhập dữ liệu thật (bước riêng) |
