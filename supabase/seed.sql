...
SELECT
  ...
  'email', now(), now(), now()
FROM "auth"."users" u
WHERE u."email" LIKE 'demo\_%@vptu.caobang.local'
...
INSERT INTO "public"."accounts"
  ("id", "username", "full_name", "role_group", "position_title", "manager_id", "department", "is_chief", "must_change_password")
VALUES
  ('00000000-0000-4000-8000-000000000001', 'demo_cvp', 'Demo Chánh Văn phòng', 'A1', 'Chánh Văn phòng', NULL, 'LANH_DAO_VAN_PHONG', true, false),
  ('00000000-0000-4000-8000-000000000002', 'demo_pcvp', 'Demo Phó Chánh Văn phòng', 'A1', 'Phó Chánh Văn phòng (Phụ trách Tổng hợp)', NULL, 'LANH_DAO_VAN_PHONG', false, false),
  ('00000000-0000-4000-8000-000000000006', 'demo_pcvp2', 'Demo Phó Chánh Văn phòng Hai', 'A1', 'Phó Chánh Văn phòng (Phụ trách Quản trị)', NULL, 'LANH_DAO_VAN_PHONG', false, false),
  ('00000000-0000-4000-8000-000000000003', 'demo_truongphong', 'Demo Trưởng phòng', 'A2', 'Trưởng phòng', '00000000-0000-4000-8000-000000000002', 'TONG_HOP', false, false),
  ('00000000-0000-4000-8000-000000000004', 'demo_cv1', 'Demo Chuyên viên Một', 'A3', 'Chuyên viên', '00000000-0000-4000-8000-000000000002', 'TONG_HOP', false, false),
  ('00000000-0000-4000-8000-000000000005', 'demo_cv2', 'Demo Chuyên viên Hai', 'A3', 'Chuyên viên', '00000000-0000-4000-8000-000000000006', 'QUAN_TRI', false, false)
